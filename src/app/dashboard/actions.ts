...
// We prioritize the server-side key, but fallback to public if that's all we have (though not recommended)
...
export async function classifyIntent(
    ...
    Rules:
    - Return "generate" IF the user is asking to create, build, design, modify, update, change, or fix a website AND provides enough specific detail to take action.
    - Return "chat" IF the user is asking a general question, greeting, or if the request is too vague.
